...
export default function PropertyCard({ 
  ...
  return (
    <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg hover:shadow-amber-500/20 transition-all duration-300 transform hover:-translate-y-2">
      <Link href={`/imoveis/${id}`}>
        <div className="relative overflow-hidden h-56">
          ...
          />
          <div className="absolute top-0 right-0 bg-amber-500 text-black font-bold px-3 py-1 z-10 rounded-bl-lg">
            {formattedPrice}
          </div>
        </div>
      </Link>
      <div className="p-6">
        ...
        <div className="flex justify-between text-sm mb-6 bg-gray-700 p-3 rounded-lg">
        ...
        <Link href={`/imoveis/${id}`} className="block">
          <button className="w-full bg-amber-500 hover:bg-amber-600 text-black font-bold py-3 rounded transition-colors duration-300 flex items-center justify-center">
            Ver Detalhes
